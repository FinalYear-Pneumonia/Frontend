...
const NUM_REGEX = /^\+?[0-9]\d{1,20}$/;
const REGISTER_URL = '/user/signup';//from backend
        ...
        <section>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <p id="uidnote" className={emailFocus && email && !validEmail ? "instructions" : "offscreen"}>
                    <FontAwesomeIcon icon={faInfoCircle} />
                    Prefix appears to the right of @ symbol<br/>
                    Domain appears to the left of @ symbol
                </p>
                ...
                />
                <p id="uidnote" className={numFocus && num && !validNum ? "instructions" : "offscreen"}>
                    <FontAwesomeIcon icon={faInfoCircle} />
                    Must be numbers from one to twenty characters.
                </p>
